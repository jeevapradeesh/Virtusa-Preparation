...
let questions = [
    ...
    question: " What is the result of the following? -82 x 39 + 235  ",
    answer: "2963",
    options: [
      "2963",
      "2960",
    ...
    question: " Which of the numbers is exactly divisible by 11?",
    answer: "415591",
    options: [
      "1234",
      "9685",
    ...
    question: " What will be the remainder when 17^200is divided by 18?",
    answer: "1",
    options: [
      "2",
      "3",
    ...
    question: "If unit digit in 549 x 56 x 28p x 684 is 8 then what is p?",
    answer: "3",
    options: [
      "2",
      "6",
    ...
    question: "8 - 106 x 106 + 94 x 94 = y. What is y?",
    answer: "20052",
    options: [
      "20062",
      "20063",
...
function showQuetions(index){
    ...
    let que_tag = '<span>'+ serial[index].numb + ". " + questions[index].question +'</span>';
